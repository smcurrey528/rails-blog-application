...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { author: @answer.author, body: @answer.body, title: @answer.title } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { author: @answer.author, body: @answer.body, title: @answer.title } }
